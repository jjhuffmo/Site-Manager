...
namespace Site_Manager
{
    public class CloseableTab : TabItem
    {
        ...
        public static readonly RoutedEvent CloseTabEvent = EventManager.RegisterRoutedEvent("CloseTab", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(CloseableTab));
        ...
        {
            ((CloseableHeader)this.Header).close_tab_image.ImageSource = new BitmapImage(new Uri(@"pack://application:,,,/Resources/close_tab_active.bmp")); ;
        }
        ...
        {
            ((CloseableHeader)this.Header).close_tab_image.ImageSource = new BitmapImage(new Uri(@"pack://application:,,,/Resources/close_tab.bmp")); ;
        }
